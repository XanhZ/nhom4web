...
@WebServlet("/admin/sach-chi-tiet")
public class AdminSachChiTietController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (nguoiDung == null) {
            ...
            if(nguoiDung.getLoaiNguoiDung() == 0){
                ...
                long maSach = Long.parseLong((String) req.getParameter("maSach"));
                req.setAttribute("ma",maSach);
                RequestDispatcher rd = req.getRequestDispatcher("/views/ad_sach_chitiet.jsp");
                rd.forward(req, resp);
            }
        }
    }
