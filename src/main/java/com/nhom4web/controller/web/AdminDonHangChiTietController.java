...
@WebServlet("/admin/don-hang-chi-tiet")
public class AdminDonHangChiTietController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (nguoiDung == null) {
            ...
            if(nguoiDung.getLoaiNguoiDung() == 0){
                ...
                long maDonHang = Long.parseLong((String) req.getParameter("maDonHang"));
                req.setAttribute("maDonHang",maDonHang);
                RequestDispatcher rd = req.getRequestDispatcher("/views/ad_hoadon_chitiet.jsp");
                rd.forward(req, resp);
            }
        }
    }
